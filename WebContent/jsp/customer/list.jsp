...
<SCRIPT language=javascript>
	...
	$(function(){
		...
		//客户级别
		var url =" ${pageContext.request.contextPath}/dict_finByCode.action";
		var param = {"dict_type_code":"006"};
		...
		$.post(url,param,function(data){
			$(data).each(
				function(i,n){
					var souceId = "${model.source.dict_id}";
					if(sourceId == n.dict_id){
						$("#souceId").append("<option value = '"+n.dict_id+"'>"+n.dict_item_name+"</option>")
					}else{
						$("#sourceId").append("<option value = '"+n.dict_id+"'>"+n.dict_item_name+"</option>")
					}
				});
